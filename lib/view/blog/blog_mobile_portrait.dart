...
class BlogMobilePortrait extends StatefulWidget {
  BlogMobilePortrait({Key key}) : super(key: key);

  @override
  _BlogMobilePortrait createState() => _BlogMobilePortrait();
}

class _BlogMobilePortrait extends State<BlogMobilePortrait> {
