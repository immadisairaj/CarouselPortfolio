...
class MyConstants extends InheritedWidget {
  ...
  // Profile Constants
  final String resumeLink = 'https://immadisairaj.github.io/assets/assets/Rajendra_CV.pdf';
  ...
  final List<List<String>> experience = const [
    // ['year', 'experienceName', 'subTitle', 'description'],
  ...
  final List<List<String>> opensource = const [
    // ['year', 'opensourceName', 'subTitle', 'description', 'link'],
  ...
  final List<List<String>> internships = const [
    // ['year', 'internshipName', 'subTitle', 'description'],
  ...
  final List<List<String>> certificates = const [
    // ['year', 'certificateName', 'subTitle', 'description', 'link'],
  ...
  final List<List<String>> others = const [
    // ['year', 'otherName', 'subTitle', 'description'],
